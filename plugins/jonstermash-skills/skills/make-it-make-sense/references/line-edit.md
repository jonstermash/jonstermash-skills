...
Loaded by **Pass 3 · Line**. The line-level integrity checks — the ones the editing itself tends to break.
...
## Keep process and meta out of the deliverable

Change-logs, edit rationale, "(was slide 19)," "27 slides → 25," and any summary of the work performed belong in the message to the requester, not inside the artifact. The reader of the finished piece needs the content, not its edit history — a deliverable should read as if it were always the plan.
